...
abstract class AbstractRelationship implements InterfaceRelationship
{
	...
	{
		return strtolower(Utils::classify(Utils::denamespace($class_name))). '_id';
	}
	...
	{
		$this->set_class_name(Utils::classify($this->attribute_name, true));
	}
	...
	public function load(Model $model)
	{
		...
		if (!isset($this->initialized))
		{
			if ($this->through)
			{
				...
				$through_table = Table::load(Utils::classify($this->through, true));
